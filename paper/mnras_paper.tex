% =====================================================================
% !! SUPERSEDED (2026-06-02) !!  This LaTeX file encodes the OLD v3 draft,
% whose headline numbers (detector AUC 0.62, "detection is intrinsically
% weak") were INVALIDATED by the scale-radius units bug. The CURRENT paper
% lives in paper/manuscript.md (corrected-simulator pipeline: AUC 0.982,
% real GD-1 in-distribution, completeness/characterization/DM-family/
% multistream results, new figures fig1-fig6). Regenerate this .tex from
% manuscript.md before submission. Do NOT compile this version for results.
% =====================================================================
